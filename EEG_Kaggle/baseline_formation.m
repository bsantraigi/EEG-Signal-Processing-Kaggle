...
li = lp;
data = [dinter.newData(:, 1:lp), dpre.newData(:, 1:lp)]';
...
%     labP(((i - 1)*29 + 1):(i*29), 2) = median(labP(((i - 1)*29 + 1):(i*29), 2));
    labP(((i - 1)*29 + 1):(i*29)) = median(labP(((i - 1)*29 + 1):(i*29)));
end
